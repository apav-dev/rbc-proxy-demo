...
const StaticMap = ({ lat, lng }: StaticMapProps) => {
  return (
    <img
      ...
      src={`https://api.mapbox.com/styles/v1/mapbox/streets-v12/static/${lng},${lat},9,0/500x300?access_token=pk.eyJ1IjoiYXBhdmxpY2siLCJhIjoiY2t5NHJiYXB1MGEzaTJ2b2FwajdmZDYwbiJ9.0KfKPwlk8hhgQymUjUBfdA`}
    />
  );
};
